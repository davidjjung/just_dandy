package com.davigj.just_dandy.common.worldgen.feature;
...
public class WeightedPatchFeature extends Feature<WeightedPatchConfiguration> {
    public WeightedPatchFeature(Codec<WeightedPatchConfiguration> codec) {
        super(codec);
    }

    @Override
    public boolean place(FeaturePlaceContext<WeightedPatchConfiguration> context) {
        WeightedPatchConfiguration config = context.config();
