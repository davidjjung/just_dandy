...
public class JustDandyConfig {
    ...
    public static class Common {
        ...
        public final ForgeConfigSpec.ConfigValue<Integer> dandySpawnWeight;
        public final ForgeConfigSpec.ConfigValue<Integer> manyDandySpawnWeight;
        ...
        public final ForgeConfigSpec.ConfigValue<List<? extends String>> manyDandyBiomes;
        public Common(ForgeConfigSpec.Builder builder) {
            ...
            dandySpawnWeight = builder.comment("Spawn weight for fluffy dandy worldgen features")
                    .define("dandySpawnWeight", 2);
            manyDandySpawnWeight = builder.comment("Spawn weight for fluffy dandy worldgen features in biomes where many more may spawn")
                    .define("manyDandySpawnWeight", 5);
            ...
            noDandyBiomes = builder.comment("A list of biomes where fluffy dandelion features do not generate")
                    .define("noDandyBiomes", new ArrayList<>(Arrays.asList("environmental:blossom_woods", "environmental:blossom_highlands",
                            "environmental:blossom_hills", "environmental:blossom_valleys", "autumnity:maple_forest",
                            "autumnity:maple_forest_hills")), s -> s instanceof String);
            manyDandyBiomes = builder.comment("A list of biomes where fluffy dandelion features generate more than usual")
                    .define("manyDandyBiomes", new ArrayList<>(Arrays.asList("worldofwonder:dandelion_fields")), s -> s instanceof String);
        }
    }
