...
public class JustDandyFeatures {
    ...
    public static final class Configured {
        public static final ConfiguredFeature<?, ?> FLOWER_FLUFFY_DANDELION = register("flower_fluffy_dandelion", Feature.FLOWER.configured(Configs.FLUFFY_DANDELION_CONFIG).decorated(Features.Placements.ADD_32).decorated(Features.Placements.HEIGHTMAP_SQUARE).count(1));
