...
public class JDBlocks {
	...
	public static final Supplier<Block> FLUFFY_DANDELION = BLOCKS.createBlock("fluffy_dandelion", () -> new FluffyDandelionBlock(MobEffects.SATURATION, 12, PropertyUtil.flower()));
